...
var ga = {
    ...
    clientID: null || localStorage.cid,
    userID: null || localStorage.uid,
    appName: 'appname',
    appVersion: '1.0.0',
    debug: false,
    ...
    sendRequest: function (data, callback) {
        if (!this.clientID || this.clientID == null) {
            this.clientID = localStorage.cid = this.generateClientID();
        }

        if (!this.userID || this.userID == null) {
            this.userID = localStorage.uid = this.generateClientID();
        }
